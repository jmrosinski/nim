...
SUBROUTINE solveiThLS5(nob,nbf,b1,b2,b3,b4,b5,amtx)
...
real(rt), INTENT(INOUT):: b1(nz,nob),b2(nz,nob),b3(nz,nob),b4(nz,nob),b5(nz,nob)
...
INTEGER                :: k
  ...
  do k=1,nz
      ...
      wk =                b4(k,1) &
          ...
          + amtx(k,8,1) * b4(k,8) &
          + amtx(k,9,1) * b4(k,9)
      b4(k,1) = b4(k,1) - amtx(k,1,10) * wk
      b4(k,2) = b4(k,2) - amtx(k,1,10) * wk * amtx(k,2,1)
      b4(k,3) = b4(k,3) - amtx(k,1,10) * wk * amtx(k,3,1)
      b4(k,4) = b4(k,4) - amtx(k,1,10) * wk * amtx(k,4,1)
      b4(k,5) = b4(k,5) - amtx(k,1,10) * wk * amtx(k,5,1)
      b4(k,6) = b4(k,6) - amtx(k,1,10) * wk * amtx(k,6,1)
      b4(k,7) = b4(k,7) - amtx(k,1,10) * wk * amtx(k,7,1)
      b4(k,8) = b4(k,8) - amtx(k,1,10) * wk * amtx(k,8,1)
      b4(k,9) = b4(k,9) - amtx(k,1,10) * wk * amtx(k,9,1)
      wk =                b5(k,1) &
          + amtx(k,2,1) * b5(k,2) &
          + amtx(k,3,1) * b5(k,3) &
          + amtx(k,4,1) * b5(k,4) &
          ...
          + amtx(k,8,1) * b5(k,8) &
          + amtx(k,9,1) * b5(k,9)
      b5(k,1) = b5(k,1) - amtx(k,1,10) * wk
      b5(k,2) = b5(k,2) - amtx(k,1,10) * wk * amtx(k,2,1)
      b5(k,3) = b5(k,3) - amtx(k,1,10) * wk * amtx(k,3,1)
      b5(k,4) = b5(k,4) - amtx(k,1,10) * wk * amtx(k,4,1)
      b5(k,5) = b5(k,5) - amtx(k,1,10) * wk * amtx(k,5,1)
      b5(k,6) = b5(k,6) - amtx(k,1,10) * wk * amtx(k,6,1)
      b5(k,7) = b5(k,7) - amtx(k,1,10) * wk * amtx(k,7,1)
      b5(k,8) = b5(k,8) - amtx(k,1,10) * wk * amtx(k,8,1)
      b5(k,9) = b5(k,9) - amtx(k,1,10) * wk * amtx(k,9,1)
      wk =                b1(k,2) &
          + amtx(k,3,2) * b1(k,3) &
          + amtx(k,4,2) * b1(k,4) &
          + amtx(k,5,2) * b1(k,5) &
      ...
      wk =                b4(k,2) &
          ...
          + amtx(k,8,2) * b4(k,8) &
          + amtx(k,9,2) * b4(k,9)
      b4(k,2) = b4(k,2) - amtx(k,2,10) * wk
      b4(k,3) = b4(k,3) - amtx(k,2,10) * wk * amtx(k,3,2)
      b4(k,4) = b4(k,4) - amtx(k,2,10) * wk * amtx(k,4,2)
      b4(k,5) = b4(k,5) - amtx(k,2,10) * wk * amtx(k,5,2)
      b4(k,6) = b4(k,6) - amtx(k,2,10) * wk * amtx(k,6,2)
      b4(k,7) = b4(k,7) - amtx(k,2,10) * wk * amtx(k,7,2)
      b4(k,8) = b4(k,8) - amtx(k,2,10) * wk * amtx(k,8,2)
      b4(k,9) = b4(k,9) - amtx(k,2,10) * wk * amtx(k,9,2)
      wk =                b5(k,2) &
          + amtx(k,3,2) * b5(k,3) &
          + amtx(k,4,2) * b5(k,4) &
          + amtx(k,5,2) * b5(k,5) &
          ...
          + amtx(k,8,2) * b5(k,8) &
          + amtx(k,9,2) * b5(k,9)
      b5(k,2) = b5(k,2) - amtx(k,2,10) * wk
      b5(k,3) = b5(k,3) - amtx(k,2,10) * wk * amtx(k,3,2)
      b5(k,4) = b5(k,4) - amtx(k,2,10) * wk * amtx(k,4,2)
      b5(k,5) = b5(k,5) - amtx(k,2,10) * wk * amtx(k,5,2)
      b5(k,6) = b5(k,6) - amtx(k,2,10) * wk * amtx(k,6,2)
      b5(k,7) = b5(k,7) - amtx(k,2,10) * wk * amtx(k,7,2)
      b5(k,8) = b5(k,8) - amtx(k,2,10) * wk * amtx(k,8,2)
      b5(k,9) = b5(k,9) - amtx(k,2,10) * wk * amtx(k,9,2)
      wk =                b1(k,3) &
          + amtx(k,4,3) * b1(k,4) &
          + amtx(k,5,3) * b1(k,5) &
          + amtx(k,6,3) * b1(k,6) &
      ...
      wk =                b4(k,3) &
          ...
          + amtx(k,8,3) * b4(k,8) &
          + amtx(k,9,3) * b4(k,9)
      b4(k,3) = b4(k,3) - amtx(k,3,10) * wk
      b4(k,4) = b4(k,4) - amtx(k,3,10) * wk * amtx(k,4,3)
      b4(k,5) = b4(k,5) - amtx(k,3,10) * wk * amtx(k,5,3)
      b4(k,6) = b4(k,6) - amtx(k,3,10) * wk * amtx(k,6,3)
      b4(k,7) = b4(k,7) - amtx(k,3,10) * wk * amtx(k,7,3)
      b4(k,8) = b4(k,8) - amtx(k,3,10) * wk * amtx(k,8,3)
      b4(k,9) = b4(k,9) - amtx(k,3,10) * wk * amtx(k,9,3)
      wk =                b5(k,3) &
          + amtx(k,4,3) * b5(k,4) &
          + amtx(k,5,3) * b5(k,5) &
          + amtx(k,6,3) * b5(k,6) &
          ...
          + amtx(k,8,3) * b5(k,8) &
          + amtx(k,9,3) * b5(k,9)
      b5(k,3) = b5(k,3) - amtx(k,3,10) * wk
      b5(k,4) = b5(k,4) - amtx(k,3,10) * wk * amtx(k,4,3)
      b5(k,5) = b5(k,5) - amtx(k,3,10) * wk * amtx(k,5,3)
      b5(k,6) = b5(k,6) - amtx(k,3,10) * wk * amtx(k,6,3)
      b5(k,7) = b5(k,7) - amtx(k,3,10) * wk * amtx(k,7,3)
      b5(k,8) = b5(k,8) - amtx(k,3,10) * wk * amtx(k,8,3)
      b5(k,9) = b5(k,9) - amtx(k,3,10) * wk * amtx(k,9,3)
      wk =                b1(k,4) &
          + amtx(k,5,4) * b1(k,5) &
          + amtx(k,6,4) * b1(k,6) &
          + amtx(k,7,4) * b1(k,7) &
      ...
      wk =                b4(k,4) &
          ...
          + amtx(k,8,4) * b4(k,8) &
          + amtx(k,9,4) * b4(k,9)
      b4(k,4) = b4(k,4) - amtx(k,4,10) * wk
      b4(k,5) = b4(k,5) - amtx(k,4,10) * wk * amtx(k,5,4)
      b4(k,6) = b4(k,6) - amtx(k,4,10) * wk * amtx(k,6,4)
      b4(k,7) = b4(k,7) - amtx(k,4,10) * wk * amtx(k,7,4)
      b4(k,8) = b4(k,8) - amtx(k,4,10) * wk * amtx(k,8,4)
      b4(k,9) = b4(k,9) - amtx(k,4,10) * wk * amtx(k,9,4)
      wk =                b5(k,4) &
          + amtx(k,5,4) * b5(k,5) &
          + amtx(k,6,4) * b5(k,6) &
          + amtx(k,7,4) * b5(k,7) &
          + amtx(k,8,4) * b5(k,8) &
          + amtx(k,9,4) * b5(k,9)
      b5(k,4) = b5(k,4) - amtx(k,4,10) * wk
      b5(k,5) = b5(k,5) - amtx(k,4,10) * wk * amtx(k,5,4)
      b5(k,6) = b5(k,6) - amtx(k,4,10) * wk * amtx(k,6,4)
      b5(k,7) = b5(k,7) - amtx(k,4,10) * wk * amtx(k,7,4)
      b5(k,8) = b5(k,8) - amtx(k,4,10) * wk * amtx(k,8,4)
      b5(k,9) = b5(k,9) - amtx(k,4,10) * wk * amtx(k,9,4)
      wk =                b1(k,5) &
          + amtx(k,6,5) * b1(k,6) &
          + amtx(k,7,5) * b1(k,7) &
          + amtx(k,8,5) * b1(k,8) &
      ...
      wk =                b4(k,5) &
          ...
          + amtx(k,8,5) * b4(k,8) &
          + amtx(k,9,5) * b4(k,9)
      b4(k,5) = b4(k,5) - amtx(k,5,10) * wk
      b4(k,6) = b4(k,6) - amtx(k,5,10) * wk * amtx(k,6,5)
      b4(k,7) = b4(k,7) - amtx(k,5,10) * wk * amtx(k,7,5)
      b4(k,8) = b4(k,8) - amtx(k,5,10) * wk * amtx(k,8,5)
      b4(k,9) = b4(k,9) - amtx(k,5,10) * wk * amtx(k,9,5)
      wk =                b5(k,5) &
          + amtx(k,6,5) * b5(k,6) &
          + amtx(k,7,5) * b5(k,7) &
          + amtx(k,8,5) * b5(k,8) &
          + amtx(k,9,5) * b5(k,9)
      b5(k,5) = b5(k,5) - amtx(k,5,10) * wk
      b5(k,6) = b5(k,6) - amtx(k,5,10) * wk * amtx(k,6,5)
      b5(k,7) = b5(k,7) - amtx(k,5,10) * wk * amtx(k,7,5)
      b5(k,8) = b5(k,8) - amtx(k,5,10) * wk * amtx(k,8,5)
      b5(k,9) = b5(k,9) - amtx(k,5,10) * wk * amtx(k,9,5)
      wk =                b1(k,6) &
          + amtx(k,7,6) * b1(k,7) &
          + amtx(k,8,6) * b1(k,8) &
          + amtx(k,9,6) * b1(k,9)
      ...
      wk =                b4(k,6) &
          ...
          + amtx(k,8,6) * b4(k,8) &
          + amtx(k,9,6) * b4(k,9)
      b4(k,6) = b4(k,6) - amtx(k,6,10) * wk
      b4(k,7) = b4(k,7) - amtx(k,6,10) * wk * amtx(k,7,6)
      b4(k,8) = b4(k,8) - amtx(k,6,10) * wk * amtx(k,8,6)
      b4(k,9) = b4(k,9) - amtx(k,6,10) * wk * amtx(k,9,6)
      wk =                b5(k,6) &
          + amtx(k,7,6) * b5(k,7) &
          + amtx(k,8,6) * b5(k,8) &
          + amtx(k,9,6) * b5(k,9)
      b5(k,6) = b5(k,6) - amtx(k,6,10) * wk
      b5(k,7) = b5(k,7) - amtx(k,6,10) * wk * amtx(k,7,6)
      b5(k,8) = b5(k,8) - amtx(k,6,10) * wk * amtx(k,8,6)
      b5(k,9) = b5(k,9) - amtx(k,6,10) * wk * amtx(k,9,6)
      wk =                b1(k,7) &
          + amtx(k,8,7) * b1(k,8) &
          + amtx(k,9,7) * b1(k,9)
      ...
      wk =                b4(k,7) &
          + amtx(k,8,7) * b4(k,8) &
          + amtx(k,9,7) * b4(k,9)
      b4(k,7) = b4(k,7) - amtx(k,7,10) * wk
      b4(k,8) = b4(k,8) - amtx(k,7,10) * wk * amtx(k,8,7)
      b4(k,9) = b4(k,9) - amtx(k,7,10) * wk * amtx(k,9,7)
      wk =                b5(k,7) &
          + amtx(k,8,7) * b5(k,8) &
          + amtx(k,9,7) * b5(k,9)
      b5(k,7) = b5(k,7) - amtx(k,7,10) * wk
      b5(k,8) = b5(k,8) - amtx(k,7,10) * wk * amtx(k,8,7)
      b5(k,9) = b5(k,9) - amtx(k,7,10) * wk * amtx(k,9,7)
      wk =                b1(k,8) &
          + amtx(k,9,8) * b1(k,9)
      ...
      wk =                b4(k,8) &
          + amtx(k,9,8) * b4(k,9)
      b4(k,8) = b4(k,8) - amtx(k,8,10) * wk
      b4(k,9) = b4(k,9) - amtx(k,8,10) * wk * amtx(k,9,8)
      wk =                b5(k,8) &
          + amtx(k,9,8) * b5(k,9)
      b5(k,8) = b5(k,8) - amtx(k,8,10) * wk
      b5(k,9) = b5(k,9) - amtx(k,8,10) * wk * amtx(k,9,8)
      wk =                b1(k,9)
      ...
      wk =                b4(k,9)
      b4(k,9) = b4(k,9) - amtx(k,9,10) * wk
      wk =                b5(k,9)
      b5(k,9) = b5(k,9) - amtx(k,9,10) * wk
      ...
      b4(k,9) = b4(k,9) _OP_ amtx(k,9,9)
        b4(k,1) = b4(k,1) - b4(k,9)*amtx(k,1,9)
        b4(k,2) = b4(k,2) - b4(k,9)*amtx(k,2,9)
        b4(k,3) = b4(k,3) - b4(k,9)*amtx(k,3,9)
        b4(k,4) = b4(k,4) - b4(k,9)*amtx(k,4,9)
        b4(k,5) = b4(k,5) - b4(k,9)*amtx(k,5,9)
        b4(k,6) = b4(k,6) - b4(k,9)*amtx(k,6,9)
        b4(k,7) = b4(k,7) - b4(k,9)*amtx(k,7,9)
        b4(k,8) = b4(k,8) - b4(k,9)*amtx(k,8,9)
      b5(k,9) = b5(k,9) _OP_ amtx(k,9,9)
        b5(k,1) = b5(k,1) - b5(k,9)*amtx(k,1,9)
        b5(k,2) = b5(k,2) - b5(k,9)*amtx(k,2,9)
        b5(k,3) = b5(k,3) - b5(k,9)*amtx(k,3,9)
        b5(k,4) = b5(k,4) - b5(k,9)*amtx(k,4,9)
        b5(k,5) = b5(k,5) - b5(k,9)*amtx(k,5,9)
        b5(k,6) = b5(k,6) - b5(k,9)*amtx(k,6,9)
        b5(k,7) = b5(k,7) - b5(k,9)*amtx(k,7,9)
        b5(k,8) = b5(k,8) - b5(k,9)*amtx(k,8,9)
      ...
      b4(k,8) = b4(k,8) _OP_ amtx(k,8,8)
        b4(k,1) = b4(k,1) - b4(k,8)*amtx(k,1,8)
        b4(k,2) = b4(k,2) - b4(k,8)*amtx(k,2,8)
        b4(k,3) = b4(k,3) - b4(k,8)*amtx(k,3,8)
        b4(k,4) = b4(k,4) - b4(k,8)*amtx(k,4,8)
        b4(k,5) = b4(k,5) - b4(k,8)*amtx(k,5,8)
        b4(k,6) = b4(k,6) - b4(k,8)*amtx(k,6,8)
        b4(k,7) = b4(k,7) - b4(k,8)*amtx(k,7,8)
      b5(k,8) = b5(k,8) _OP_ amtx(k,8,8)
        b5(k,1) = b5(k,1) - b5(k,8)*amtx(k,1,8)
        b5(k,2) = b5(k,2) - b5(k,8)*amtx(k,2,8)
        b5(k,3) = b5(k,3) - b5(k,8)*amtx(k,3,8)
        b5(k,4) = b5(k,4) - b5(k,8)*amtx(k,4,8)
        b5(k,5) = b5(k,5) - b5(k,8)*amtx(k,5,8)
        b5(k,6) = b5(k,6) - b5(k,8)*amtx(k,6,8)
        b5(k,7) = b5(k,7) - b5(k,8)*amtx(k,7,8)
      ...
      b4(k,7) = b4(k,7) _OP_ amtx(k,7,7)
        b4(k,1) = b4(k,1) - b4(k,7)*amtx(k,1,7)
        b4(k,2) = b4(k,2) - b4(k,7)*amtx(k,2,7)
        b4(k,3) = b4(k,3) - b4(k,7)*amtx(k,3,7)
        b4(k,4) = b4(k,4) - b4(k,7)*amtx(k,4,7)
        b4(k,5) = b4(k,5) - b4(k,7)*amtx(k,5,7)
        b4(k,6) = b4(k,6) - b4(k,7)*amtx(k,6,7)
      b5(k,7) = b5(k,7) _OP_ amtx(k,7,7)
        b5(k,1) = b5(k,1) - b5(k,7)*amtx(k,1,7)
        b5(k,2) = b5(k,2) - b5(k,7)*amtx(k,2,7)
        b5(k,3) = b5(k,3) - b5(k,7)*amtx(k,3,7)
        b5(k,4) = b5(k,4) - b5(k,7)*amtx(k,4,7)
        b5(k,5) = b5(k,5) - b5(k,7)*amtx(k,5,7)
        b5(k,6) = b5(k,6) - b5(k,7)*amtx(k,6,7)
      ...
      b4(k,6) = b4(k,6) _OP_ amtx(k,6,6)
        b4(k,1) = b4(k,1) - b4(k,6)*amtx(k,1,6)
        b4(k,2) = b4(k,2) - b4(k,6)*amtx(k,2,6)
        b4(k,3) = b4(k,3) - b4(k,6)*amtx(k,3,6)
        b4(k,4) = b4(k,4) - b4(k,6)*amtx(k,4,6)
        b4(k,5) = b4(k,5) - b4(k,6)*amtx(k,5,6)
      b5(k,6) = b5(k,6) _OP_ amtx(k,6,6)
        b5(k,1) = b5(k,1) - b5(k,6)*amtx(k,1,6)
        b5(k,2) = b5(k,2) - b5(k,6)*amtx(k,2,6)
        b5(k,3) = b5(k,3) - b5(k,6)*amtx(k,3,6)
        b5(k,4) = b5(k,4) - b5(k,6)*amtx(k,4,6)
        b5(k,5) = b5(k,5) - b5(k,6)*amtx(k,5,6)
      ...
      b4(k,5) = b4(k,5) _OP_ amtx(k,5,5)
        b4(k,1) = b4(k,1) - b4(k,5)*amtx(k,1,5)
        b4(k,2) = b4(k,2) - b4(k,5)*amtx(k,2,5)
        b4(k,3) = b4(k,3) - b4(k,5)*amtx(k,3,5)
        b4(k,4) = b4(k,4) - b4(k,5)*amtx(k,4,5)
      b5(k,5) = b5(k,5) _OP_ amtx(k,5,5)
        b5(k,1) = b5(k,1) - b5(k,5)*amtx(k,1,5)
        b5(k,2) = b5(k,2) - b5(k,5)*amtx(k,2,5)
        b5(k,3) = b5(k,3) - b5(k,5)*amtx(k,3,5)
        b5(k,4) = b5(k,4) - b5(k,5)*amtx(k,4,5)
      ...
      b4(k,4) = b4(k,4) _OP_ amtx(k,4,4)
        b4(k,1) = b4(k,1) - b4(k,4)*amtx(k,1,4)
        b4(k,2) = b4(k,2) - b4(k,4)*amtx(k,2,4)
        b4(k,3) = b4(k,3) - b4(k,4)*amtx(k,3,4)
      b5(k,4) = b5(k,4) _OP_ amtx(k,4,4)
        b5(k,1) = b5(k,1) - b5(k,4)*amtx(k,1,4)
        b5(k,2) = b5(k,2) - b5(k,4)*amtx(k,2,4)
        b5(k,3) = b5(k,3) - b5(k,4)*amtx(k,3,4)
      ...
      b4(k,3) = b4(k,3) _OP_ amtx(k,3,3)
        b4(k,1) = b4(k,1) - b4(k,3)*amtx(k,1,3)
        b4(k,2) = b4(k,2) - b4(k,3)*amtx(k,2,3)
      b5(k,3) = b5(k,3) _OP_ amtx(k,3,3)
        b5(k,1) = b5(k,1) - b5(k,3)*amtx(k,1,3)
        b5(k,2) = b5(k,2) - b5(k,3)*amtx(k,2,3)
      ...
      b4(k,2) = b4(k,2) _OP_ amtx(k,2,2)
        b4(k,1) = b4(k,1) - b4(k,2)*amtx(k,1,2)
      b5(k,2) = b5(k,2) _OP_ amtx(k,2,2)
        b5(k,1) = b5(k,1) - b5(k,2)*amtx(k,1,2)
      b1(k,1) = b1(k,1) _OP_ amtx(k,1,1)
      b2(k,1) = b2(k,1) _OP_ amtx(k,1,1)
      b3(k,1) = b3(k,1) _OP_ amtx(k,1,1)
      b4(k,1) = b4(k,1) _OP_ amtx(k,1,1)
      b5(k,1) = b5(k,1) _OP_ amtx(k,1,1)
  enddo !k-loop
END SUBROUTINE solveiThLS5
